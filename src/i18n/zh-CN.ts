export const zhCN = {
  ...
  fieldDescription: '描述',
  fieldTime: '时间',
  fieldScheduledStart: '安排开始',
  fieldScheduledEnd: '安排结束（可选）',
  fieldDueTime: '截止时间（可选）',
  fieldReminder: '提醒',
  fieldRecurrence: '重复',
  ...
  agentAccess: 'AI / Agent 接入',
  agentAccessDescription: '把地址和令牌配置给可信任的本机 AI。令牌不要公开分享。',
  agentEndpoint: '接口地址',
  agentMcpEndpoint: 'MCP 地址（配置给 Codex）',
  agentToken: '访问令牌',
  showToken: '显示',
  hideToken: '隐藏',
  copyToken: '复制',
  ...
  regenerateTokenConfirm: '重新生成后，之前配置给 AI 的令牌会立即失效。确定继续吗？',
  windowOpacity: '窗口透明度',
  themeColor: '主题色',
